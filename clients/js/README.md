# JavaScript client for Mpl Buffer
...
2. Next, install this library using the package manager of your choice.
   ```sh
   npm install @metaplex-foundation/mpl-buffer
   ```
2. Finally, register the library with your Umi instance like so.
   ```ts
   import { mplBuffer } from '@metaplex-foundation/mpl-buffer';
   umi.use(mplBuffer());
   ```

You can learn more about this library's API by reading its generated [TypeDoc documentation](https://mpl-buffer-js-docs.vercel.app).

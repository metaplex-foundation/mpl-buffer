...
use crate::error::MplBufferError;
use crate::instruction::accounts::CreateAccounts;
use crate::instruction::{CreateArgs, MplBufferInstruction};
...
pub fn process_instruction<'a>(
    ...
    let instruction: MplBufferInstruction =
        MplBufferInstruction::try_from_slice(instruction_data)?;
    match instruction {
        MplBufferInstruction::Create(args) => {
